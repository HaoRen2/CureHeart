...
exports.PacienteModule = PacienteModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([paciente_entity_1.Paciente]), citas_module_1.CitasModule, informe_module_1.InformeModule],
        controllers: [paciente_controller_1.PacienteController],
        providers: [paciente_service_1.PacienteService, citas_service_1.CitasService],
    })
], PacienteModule);
